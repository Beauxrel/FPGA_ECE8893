...
#pragma HLS ARRAY_PARTITION variable=tmp cyclic factor=8 dim=0
#pragma HLS ARRAY_PARTITION variable=A   cyclic factor=8 dim=0
#pragma HLS ARRAY_PARTITION variable=C   cyclic factor=8 dim=0
