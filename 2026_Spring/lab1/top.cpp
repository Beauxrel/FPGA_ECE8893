...
{
#pragma HLS interface mode=axis port = A_DRAM offset = slave bundle = A max_widen_bitwidth=512 max_read_burst_length=64
#pragma HLS interface mode=axis port = C_DRAM offset = slave bundle = C max_widen_bitwidth=512 max_read_burst_length=64
